...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(2005, 10, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(2015, 10, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1995, 10, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 0,
    originDate: format(new Date(2005, 10, 2), inputDateFormat),
  ...
  methods: {
    async getHeroes() {
      return new Promise((resolve) => {
        setTimeout(() => resolve(ourHeroes), 2000);
      });
    },
    async loadHeroes(){
      this.heroes = [];
